...
- (void)setupObject{
    ...
    temlate1.backgroundColor = UIColorFromRGB(0xf2f2f2);
...
//    temlate1.textPatameters = @[textPatameter1,textPatameter2];
    ...
    temlate2.backgroundColor = UIColorFromRGB(0xf2f2f2);
    ...
    group1.title = @"iPhone 设备（1242*2208）";
    ...
    temlateX1.backgroundColor = UIColorFromRGB(0xf2f2f2);
    ...
    temlateX2.backgroundColor = UIColorFromRGB(0xf2f2f2);
